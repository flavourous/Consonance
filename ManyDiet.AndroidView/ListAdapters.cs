...
namespace ManyDiet.AndroidView
{
	...
	class LAdapter : BaseAdapter<EatEntryLineVM>
	{
		readonly Activity context;
		readonly List<EatEntryLineVM> vms;
		readonly String useTrack;
		public LAdapter(Activity context, List<EatEntryLineVM> vms, String useTrack)
		{
		...
		public override View GetView (int position, View convertView, ViewGroup parent)
		{
			...
			var find = vms [position].trackedAmounts.FindAll (k => k.Key == useTrack);
			if(find.Count > 0)
		...
		public override EatEntryLineVM this [int index] { get { return vms [index]; } }
		#endregion
	}
